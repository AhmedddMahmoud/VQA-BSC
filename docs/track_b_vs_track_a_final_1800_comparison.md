...
- Metrics JSON: `logs/eval_track_b_paligemma_metrics_val_1800_kaggle_20260421_143715.json`
- Predictions JSONL: `predictions/eval_track_b_paligemma_predictions_val_1800_kaggle_20260421_143715.jsonl`
- Failures JSONL: `predictions/eval_track_b_paligemma_failures_val_1800_kaggle_20260421_143715.jsonl`
...
## Scaling Validation Note

The 1800-sample outcome is consistent with larger Track B runs:
...
This indicates the Track B advantage is not a small-subset artifact. See `docs/track_b_paligemma_scaling_validation.md` for details and artifact references.
